<template>
    <button v-bind:class="classVisible" v-on:click="$emit('onclick')">
        <font-awesome-icon :icon="iconName" :style="{ color: '#FFF', fontSize:'16px' }" />
    </button>
</template>
...
<script>
    export default {
        ...
        props: ['classType', 'classVisible', 'iconName']
    }
</script>
